object FFacture: TFFacture
  ...
  object PEnteteAffaire: THPanel
    ...
    object LBMODERECH: THLabel
      Left = 7
      Top = 122
      Width = 108
      Height = 13
      Caption = 'Rech. Ref'#233'rence dans'
    end
    ...
    object TMODERECH: THValComboBox
      Left = 124
      Top = 118
      Width = 191
      Height = 21
  ...
  object POPY: TPopupMenu
    ...
    object MnRecalLigneFac: TMenuItem
      Caption = 'Recalcul LigneFac'
      OnClick = MnRecalLigneFacClick
    end
    object ReprisePuOrigne: TMenuItem
      Caption = 'Reprise des valorisations origine'
      OnClick = ReprisePuOrigneClick
    end
